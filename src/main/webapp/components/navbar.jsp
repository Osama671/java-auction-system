<nav class="navbar bg-dark bg-body-tertiary gap-3 px-2" data-bs-theme="dark">
    ...
    <form class="form-inline flex-grow-1" method="get" action="<%=request.getContextPath()%>/" style="display: flex;">
        <input class="form-control mr-sm-2 me-1" id="search" name="search" type="search" placeholder="Search"
    ...
    <form class="form-inline" method="post" action="<%=request.getContextPath()%>/account/sign-out">
